...
def insert_training_form(form_data):
    ...
    cursor.execute(
        ...
        INSERT INTO training_forms (
            ...
            trainer_hours, trainees_data, approved, concur_claim, travel_cost,
            food_cost, materials_cost, other_cost, other_expense_description,
            trainee_hours, training_description, submitter
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """,
        (
...
def get_training_form(form_id):
    ...
    if row:
        ...
        return {
            ...
            "trainer_hours": row_dict["trainer_hours"],
            ...
            "trainee_hours": row_dict.get("trainee_hours", 0.0) or 0.0,
